...
#define LINUX_VER "5.4.243-yocto-standard"
...
int main(void)
{
	...
	printf("insmod /lib/modules/" LINUX_VER "/extra/" MODULE_NAME ".ko\n");
	if (system("insmod /lib/modules/" LINUX_VER "/extra/" MODULE_NAME ".ko\n")) {
